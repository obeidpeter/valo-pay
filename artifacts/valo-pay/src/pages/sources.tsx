...
function Sources() {
  ...
  return <div className="space-y-6">
    ...
    <PilotPanel title="Source totals & import evidence">
      <p className="text-sm text-muted-foreground">Source totals include every uploaded row. Newly imported totals exclude rows already saved by an earlier batch. Each total adds the naira rows; money in another currency is listed beside it, never added to it. A batch committed before 25 September 2026 keeps the totals it was committed with, which may add rows in other currencies. Open a batch to inspect its original source IDs and row checks.</p>
