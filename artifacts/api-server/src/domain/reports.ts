import { PLAN_GROSS_MARGIN, VARIABLE_COST_PER_COLLECTION_KOBO, counted, experimentRules, isOpenException, measurementRules, paymentAppliedKobo, type RecordKind } from "@workspace/valopay-schema";
