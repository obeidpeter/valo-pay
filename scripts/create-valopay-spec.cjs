...
derived("OperationView", shared.operationViewSchema, "One journal entry: what was asked, by whom, in which role, and whether the service confirmed it. Original request bodies stay private; a completed entry names the record it produced. A refused entry is cancelled and its message says why.");
...
operation("/v1/team/changes/{id}/decline", "post", "declineStaffChange", "Message", null, [pathParam("id")], "Decline or withdraw a membership change", "Administrator with recent MFA; the administrator who asked withdraws it the same way. Recorded in the access history; the membership is unchanged. A request already approved or declined is refused (409).");
