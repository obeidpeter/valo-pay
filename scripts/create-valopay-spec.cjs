...
const schemaDescriptions = {
  ...
  RecordUpdate: "The fields to change on a record; omitted fields keep their values. A name cannot be empty, and a status, reference or customerId is bounded as a new record's is.",
