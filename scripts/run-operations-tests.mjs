...
for(const name of ['close-review','source-quality','source-completeness','import-corrections','source-ingress','personal-work','staff-lender-access','protected-payloads','recovery-manifest','lifecycle','lifecycle-run','retention-storage']){
