...
FROM (VALUES
  ...
  ('unique index', 'valopay_unique_observation', 'valopay_records', 'USING btree (merchant_id, ((data ->> ''source''::text)), ((data ->> ''eventId''::text))) WHERE ((kind = ''observations''::text) AND ((data ->> ''eventId''::text) IS NOT NULL))'),
